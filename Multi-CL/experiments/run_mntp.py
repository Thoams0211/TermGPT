...
def main():
    ...
    config_parser.add_argument("-c", "--config_path", type=str, required=True, help="The path of the configuration file")
    args, _ = config_parser.parse_known_args()
    config_path = args.config_path

    # if len(sys.argv) == 5 and sys.argv[4].endswith(".json"):
